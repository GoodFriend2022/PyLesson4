...
n = int(input('Введите количество кустов черники, растущих на грядке > '))
shrubs = CreateArray(n)
print(shrubs)
print(f'Максимальное количество ягод с трех кустов равно = {Harvest(shrubs)}')
